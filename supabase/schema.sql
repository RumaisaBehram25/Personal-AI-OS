-- =====================================================================
-- HypoOS MVP — FULL SCHEMA (all migrations combined, in order)
-- Paste this entire file into the Supabase SQL Editor and click "Run".
-- Safe to run once on a fresh project. Order matters; do not reorder.
-- =====================================================================


-- =====================================================================
-- 0001_foundation : extensions + shared helper
-- =====================================================================
...
-- =====================================================================
-- 0002_users : app profile extending auth.users
-- =====================================================================
...
-- =====================================================================
-- 0003_prefs : per-user settings (1:1) + signup trigger
-- =====================================================================
...
-- =====================================================================
-- 0005_messages : tool_calls (function calling) + embedding (pgvector)
-- =====================================================================
...
-- =====================================================================
-- 0010_calendar_conn : OAuth tokens (server-role-only via RLS w/ no policies)
-- =====================================================================
...
-- (No policies: only the service role can access these token rows.)


-- =====================================================================
-- 0011_exec_logs : AI tool-call audit log
-- =====================================================================
...
-- =====================================================================
-- 0012_grants : grant table privileges to Supabase API roles.
-- RLS still gates which ROWS each role can touch; these grants just give
-- the roles table-level access. service_role bypasses RLS entirely.
-- =====================================================================
...
-- Apply automatically to any tables/sequences/functions created later.
...
-- =====================================================================
-- DONE. Verify in Table Editor: 10 tables should now exist.
-- =====================================================================
